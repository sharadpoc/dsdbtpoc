...
SELECT
        ...
        FROM
            ...
            ON  mov_MDM_CREDIT_RISK_RATING_SRC.SRC_DL = mov_MDM_CRD_RISK_Rating_TGT.SRC_DL
 				AND mov_MDM_CREDIT_RISK_RATING_SRC.SRC_ID = mov_MDM_CRD_RISK_Rating_TGT.SRC_ID
 				AND mov_MDM_CREDIT_RISK_RATING_SRC.CR_RSK_RTG_ID = mov_MDM_CRD_RISK_Rating_TGT.CR_RSK_RTG_ID
 				AND mov_MDM_CREDIT_RISK_RATING_SRC.DATE_FROM = mov_MDM_CRD_RISK_Rating_TGT.DATE_FROM
)
