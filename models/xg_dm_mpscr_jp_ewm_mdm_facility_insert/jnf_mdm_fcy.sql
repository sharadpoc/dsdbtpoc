...
SELECT
        ...
        FROM
            ...
            FULL OUTER JOIN {{ ref('mov_mdm_fcy_tgt') }} AS MOV_MDM_FCY_TGT ON MOV_FCY_SRC.SRC_ID=MOV_MDM_FCY_TGT.SRC_ID
            AND MOV_FCY_SRC.FCY_ID=MOV_MDM_FCY_TGT.FCY_ID
            AND MOV_FCY_SRC.AR_ID=MOV_MDM_FCY_TGT.AR_ID
            AND MOV_FCY_SRC.SRC_DL=MOV_MDM_FCY_TGT.SRC_DL
            AND MOV_FCY_SRC.DATE_FROM=MOV_MDM_FCY_TGT.DATE_FROM 
)
