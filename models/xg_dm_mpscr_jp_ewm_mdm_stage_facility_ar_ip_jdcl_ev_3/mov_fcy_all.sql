...
SELECT
            	...
            	MOV_FCY_CRT_CTRL.LMTG_AR_MSTR_SRC_STM_KEYMOV_FCY_CRT_CTRL.MSTR_SRC_STM_KEY AS UNDRL_AR_ID,
            	MOV_FCY_CRT_CTRL.LMTG_AR_MSTR_SRC_STM_KEYMOV_FCY_CRT_CTRL.FCY_AR_TP AS FCY_AR_TP,
            	MOV_FCY_CRT_CTRL.EV_JDCL_EV_V_ID AS COURT_CTRLD_WRKOUT_FCY,
            	MOV_FCY_CRT_CTRL.AR_DEFAULT_INDMOV_FCY_CRT_CTRL.IP_DEFAULT_INDMOV_FCY_CRT_CTRL.EV_JDCL_EV_V_ID AS OUT_OF_COURT_WRKOUT_FCY,
            	MOV_FCY_CRT_CTRL.ACT_STRT_DT AS COURT_CTRLD_WRKOUT_FILL_DT,
            	MOV_FCY_CRT_CTRL.ACT_END_DT AS COURT_CTRLD_WRKOUT_CLS_DT,
            	MOV_FCY_CRT_CTRL.AR_DEFAULT_INDMOV_FCY_CRT_CTRL.IP_DEFAULT_IND AS CR_OBLG_DFLTD,
