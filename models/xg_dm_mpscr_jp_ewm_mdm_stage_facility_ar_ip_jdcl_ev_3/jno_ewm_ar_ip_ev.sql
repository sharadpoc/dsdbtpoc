...
SELECT
        ...
        FROM
            ...
            LEFT OUTER JOIN {{ ref('mov_srt_ip_x_ev_id') }} AS MOV_SRT_IP_X_EV_ID ON MOV_SRT_AR_X_IP_ID.SRC_DL=MOV_SRT_IP_X_EV_ID.SRC_DL
            AND MOV_SRT_AR_X_IP_ID.IP_ID=MOV_SRT_IP_X_EV_ID.IP_ID 
)
