...
WITH ora_read_ewm_ar_rprch_agrm_txn_v AS (
SELECT
    SRC_DL,
    ...
    MSTR_SRC_STM_KEY,
    AR_ID,
    'RPRCH_AGRM_TXN' AS FCY_AR_TP
FROM
    {{ source('DBT_SID2', 'EWM_AR_RPRCH_AGRM_TXN_V') }}
WHERE
    1 = 1
...
SELECT * FROM ora_read_ewm_ar_rprch_agrm_txn_v
