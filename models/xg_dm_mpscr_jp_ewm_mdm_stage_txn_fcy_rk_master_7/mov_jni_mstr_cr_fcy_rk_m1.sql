...
WITH mov_jni_mstr_cr_fcy_rk_m1 AS (
SELECT
            		MOV_SRT_OBJ_AR_ID_OBJ_AR_ID AS OBJ_AR_ID,
            	MOV_SRT_OBJ_AR_ID_SRC_DL AS SRC_DL,
            	MOV_SRT_OBJ_AR_ID_SUBJ_AR_ID AS SUBJ_AR_ID,
        ...
        FROM
            {{ ref('jni_mstr_cr_fcy_rk') }} AS JNI_MSTR_CR_FCY_RK 
)

SELECT * FROM mov_jni_mstr_cr_fcy_rk_m1
