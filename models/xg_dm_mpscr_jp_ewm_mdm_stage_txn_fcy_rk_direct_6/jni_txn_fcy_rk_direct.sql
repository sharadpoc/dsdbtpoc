...
SELECT
            	...
            	MOV_SRT_EWM_STG_FCY_TXN.PRIM_AR_ID AS MOV_SRT_EWM_STG_FCY_TXN_PRIM_AR_ID,
        ...
        FROM
            ...
            INNER JOIN {{ ref('mov_srt_ewm_stg_fcy_txn') }} AS MOV_SRT_EWM_STG_FCY_TXN ON MOV_SRT_EWM_STG_FCY_TXN.SRC_DL=MOV_SRT_EWM_TXN_V_AR_ID.SRC_DL
            AND MOV_SRT_EWM_STG_FCY_TXN.PRIM_AR_ID=MOV_SRT_EWM_TXN_V_AR_ID.PRIM_AR_ID 
)

SELECT * FROM jni_txn_fcy_rk_direct
