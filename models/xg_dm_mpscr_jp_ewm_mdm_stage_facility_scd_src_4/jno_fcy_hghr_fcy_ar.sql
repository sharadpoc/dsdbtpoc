...
SELECT
        ...
        FROM
            ...
            LEFT OUTER JOIN {{ ref('mov_srt_fcy_ar_hgr') }} AS MOV_SRT_FCY_AR_HGR ON MOV_SRT_HGR_HST_FCY.SRC_DL=MOV_SRT_FCY_AR_HGR.SRC_DL
            AND MOV_SRT_HGR_HST_FCY.HIGHER_FCY_ID=MOV_SRT_FCY_AR_HGR.HIGHER_FCY_ID 
)
