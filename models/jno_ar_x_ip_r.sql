...
SELECT
        ...
        FROM
            ...
            LEFT OUTER JOIN {{ ref('mov_srt_ewm_ar_x_ip_r') }} AS MOV_SRT_EWM_AR_X_IP_R ON MOV_SRT_EWM_IP_ALT_IDENTN_VORTEX.IP_ID=MOV_SRT_EWM_AR_X_IP_R.IP_ID
            AND MOV_SRT_EWM_IP_ALT_IDENTN_VORTEX.SRC_DL=MOV_SRT_EWM_AR_X_IP_R.SRC_DL 
)
